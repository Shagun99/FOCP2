...
import com.ncu.assignment.validation.StudentValidation;
...
public class StudentDriver
{
	public static void main(String args[])
	{
		...
		sv.dateValidator(daydob, monthdob, yeardob);
...
//		String skills;
		...
		//		String responsibilities;
				...
				sv.dateValidator(startday, startmonth, startyear);
				sv.dateValidator(endday, endmonth, endyear);
		...
		sv.studentValidator(s, firstName, lastName, eMail, contactNo, line1, line2, city, state, q);
